...
echo "TREASURY_DAO_ADDRESS=$TREASURY_DAO_ADDRESS"
echo "REGISTRY_DAO_ADDRESS=$REGISTRY_DAO_ADDRESS"
echo "DUMMY_FA2_ADDRESS=$DUMMY_FA2_ADDRESS"
echo "DUMMY_GUARDIAN_ADDRESS=$DUMMY_GUARDIAN_ADDRESS"
